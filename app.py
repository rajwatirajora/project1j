...
X_whole = pd.read_csv('data/listings_3.csv')
imp_header = 'room_type_Entire home/apt,accommodates,gym,bedrooms,dishwasher,kitchen,longitude,room_type_Hotel room,latitude,refrigerator,cable_tv,pool,neighbourhood_Near North Side,reviews_per_month,neighbourhood_Albany Park,indoor_fireplace,minimum_nights,calculated_host_listings_count,availability_365,iron,neighbourhood_Loop,washer,room_type_Shared room,review_scores_rating,number_of_reviews,neighbourhood_Lincoln Park,neighbourhood_Washington Park,heating,hair_dryer,stove,neighbourhood_Lake View,neighbourhood_Logan Square,neighbourhood_Near West Side,room_type_Private room,maximum_nights,neighbourhood_East Garfield Park,hot_water,microwave,neighbourhood_South Chicago,neighbourhood_Uptown,neighbourhood_Belmont Cragin,neighbourhood_Oakland,neighbourhood_Englewood,neighbourhood_New City,neighbourhood_Austin,dryer,neighbourhood_Dunning'      
...
st.title("Chicago Airbnb Data Analysis")
...
if box == "Project Overview":
    ...
    <br>
    <p> <h3> You can view the solutions python notebook <a href="https://colab.research.google.com/drive/1AxqlqSM0mhzVcH_4FmHWof8Gsqc03vVW?usp=sharing" target="_blank">HERE </a> </h3> </p>
